...
public abstract class ExtensibleTypeRepositoryBase<
  ...
  public void deleteById(ID extensibleTypeId) {
    ...
    propertyTypeRepository()
        .findByExtensibleTypeId(extensibleTypeId)
        .forEach(
            propertyType ->
                propertyTypeRepository().deleteById(Objects.requireNonNull(propertyType.getId())));
    // un-reference Extensible
