...
public class ExtensibleReferenceMapper extends ReferenceMapper<Long, TestExtensibleEntity> {
  ...
  @Override
  protected Class<TestExtensibleEntity> entityClass() {
    return TestExtensibleEntity.class;
  }
}
